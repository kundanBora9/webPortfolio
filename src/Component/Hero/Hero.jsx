...
function Hero() {
  return (
    <div id='home' className='text-white m-20 gap-1'>
      ...
      <img src={profileimg} alt="" className=' size-1/4 mx-auto md:size-3/12   lg:size-3/12 ' />
        <h1 className='text-4xl md:text-5xl lg:text-7xl'><span className=' sm:text-3xl md:text-5xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-yellow-500 md:break-after-column'>I'm Kundan Bora,</span>Frontend developer based in India.</h1>
        <p className='text-2xl md:text-2xl lg:text-2xl'>Passionate front-end developer with a creative flair and a drive for continuous learning.</p>
      </div>
