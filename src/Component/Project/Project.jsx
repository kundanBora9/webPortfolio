...
function Project() {
  return (
    <div id="Project" className="">
      ...
      <h1 className="text-white text-center text-2xl mt-3">
        Each Project is a unique piece of development
      </h1>
      </div>
      <div className="flex flex-col md:flex-row items-center mt-10 mx-20">
        <div className="">
          <img src={Project_1} alt="" className="w-3/4 h-3/4 mx-auto my-3" />
        </div>
        <div className="w-4/5 text-white">
          <p className="w-9/12 mx-3 my-3">
      ...
      <div className="flex flex-col md:flex-row items-center mt-10 mx-20">
        <div className="">
          <img src={project_2} alt="" className="w-3/4 h-3/4 mx-auto my-3" />
        </div>
        <div className="w-4/5 text-white">
          <p className="w-9/12 mx-3 my-3">
      ...
      <div className="flex flex-col md:flex-row items-center mt-10 mx-20">
        <div className="">
          <img src={project_3} alt="" className="w-3/4 h-3/4 mx-auto my-3" />
        </div>
        <div className="w-4/5 text-white">
          <p className="w-9/12 mx-3 my-3">
      ...
      <div className="flex flex-col md:flex-row items-center mt-10 mx-20">
        <div className="">
          <img src={project_4} alt="" className="w-3/4 h-3/4 mx-auto my-3" />
        </div>
        <div className="w-4/5 text-white">
          <p className="w-9/12 mx-3 my-3">
